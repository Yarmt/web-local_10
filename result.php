...
<body class="body">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($inputText)) {
            ...
            $wordArray = preg_split('/[\s\pP]+/u', $inputText, -1, PREG_SPLIT_NO_EMPTY); //исключает пустые элементы
            ...
            echo "<table>";
            echo "<tr><th>Информация</th><th>Количество вхождений</th></tr>";
    ...
    <input type="submit" value="Другой анализ" class="bton">
    </form>
</body>
